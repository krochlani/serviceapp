...
extension Category {
    ...
    static let billsAndUtilites = Category(id: 2, name: "Bills & Utilities", icon: .file_invoice_dollar)
    ...
    static let donation = Category(id: 88, name: "Donation", icon: .hand_holding_usd, mainCategoryId: 4)
    static let expense = Category(id: 98, name: "Expense", icon: .dollar_sign, mainCategoryId: 7)
    static let fundraiser = Category(id: 103, name: "Fundraiser", icon: .file_invoice_dollar)
